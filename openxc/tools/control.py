...
def filter_message(interface, bus, message_id):
    if interface.filter_message(bus, message_id):
        print("Bus %u message_id %s now active" % (bus,message_id))
    else:
        print("Cannot set message_id")
