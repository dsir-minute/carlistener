...
_CONTROLCOMMAND_TYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='FILTER_MESSAGE', index=7, number=8,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_CONTROLCOMMAND = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='filter_message_request', full_name='openxc.ControlCommand.filter_message_request', index=6,
...
_FILTERMESSAGECOMMAND = descriptor.Descriptor(
  name='FilterMessageCommand',
  full_name='openxc.FilterMessageCommand',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='bus', full_name='openxc.FilterMessageCommand.bus', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='id', full_name='openxc.FilterMessageCommand.id', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='max_frequency', full_name='openxc.FilterMessageCommand.max_frequency', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='force_send_changed', full_name='openxc.FilterMessageCommand.force_send_changed', index=3,
...
_CONTROLCOMMAND.fields_by_name['filter_message_request'].message_type = _FILTERMESSAGECOMMAND
...
DESCRIPTOR.message_types_by_name['FilterMessageCommand'] = _FILTERMESSAGECOMMAND
...
class FilterMessageCommand(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FILTERMESSAGECOMMAND
  
  # @@protoc_insertion_point(class_scope:openxc.FilterMessageCommand)
