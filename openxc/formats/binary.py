...
class ProtobufFormatter(object):
    ...
    def _command_string_to_protobuf(self, command_name):
        ...
        elif command_name == "filter_message":
            return openxc_pb2.ControlCommand.FILTER_MESSAGE
    ...
    def _dict_to_protobuf(cls, data):
        ...
        if 'command' in data:
            ...
            elif message.control_command.type == openxc_pb2.ControlCommand.FILTER_MESSAGE:
                message.control_command.filter_message_request.bus = data['bus']
                message.control_command.filter_message_request.id = data['id']
    ...
    def _protobuf_to_dict(cls, message):
        ...
        if message is not None:
            if message.type == message.CAN and message.HasField('can_message'):
                ...
                elif command.type == openxc_pb2.ControlCommand.FILTER_MESSAGE:
                    parsed_message['command'] = "filter_message"
                    parsed_message['bus'] = command.filter_message_request.bus
                    parsed_message['id'] = command.filter_message_request.id
                ...
                elif response.type == openxc_pb2.ControlCommand.FILTER_MESSAGE:
                    parsed_message['command_response'] = "filter_message"
