...
class Controller(object):
    ...
    def filter_message(self, bus, mid, max_frequency=None, force_send_changed=None):
        """Allows VI to forward CAN messages with id mid
        ...
        if max_frequency is not None:
            request['max_frequency'] = max_frequency
        if force_send_changed is not None:
            request['force_send_changed'] = force_send_changed
